							...
							std::string Answer7 = "")
{
		...
		do {
			...
			if(Answer3 != "") std::cout<<" [3] "<<Answer3<<"\n";
			if(Answer4 != "") std::cout<<" [4] "<<Answer4<<"\n";
			if(Answer5 != "") std::cout<<" [5] "<<Answer5<<"\n";
			if(Answer6 != "") std::cout<<" [6] "<<Answer6<<"\n";
			if(Answer7 != "") std::cout<<" [7] "<<Answer7<<"\n";
