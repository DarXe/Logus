...
std::string genVer()
{
    ...
    //month
    if(cDate.find("Jan") != std::string::npos) month = "01";
    if(cDate.find("Feb") != std::string::npos) month = "02";
    if(cDate.find("Mar") != std::string::npos) month = "03";
    if(cDate.find("Apr") != std::string::npos) month = "04";
    if(cDate.find("May") != std::string::npos) month = "05";
    if(cDate.find("Jun") != std::string::npos) month = "06";
    if(cDate.find("Jul") != std::string::npos) month = "07";
    if(cDate.find("Aug") != std::string::npos) month = "08";
    if(cDate.find("Sep") != std::string::npos) month = "09";
    if(cDate.find("Oct") != std::string::npos) month = "10";
    if(cDate.find("Nov") != std::string::npos) month = "11";
